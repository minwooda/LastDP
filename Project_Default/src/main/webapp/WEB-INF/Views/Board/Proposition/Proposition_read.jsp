				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<input type="text" id="proposition_subject" name="proposition_subject" class="form-control" readonly="readonly" />
						</div><br />
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea name="proposition_content" id="proposition_content" class="form-control" cols="30" rows="10" style="resize: none" readonly="readonly"></textarea>
						</div><br />
						<div class="form-group">
							<label for="proposition_file">이미지</label> 
							<img src="#" width="100%" />
						</div><br />
						<div class="form-group">
