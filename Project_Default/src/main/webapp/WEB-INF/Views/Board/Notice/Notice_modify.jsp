					...
					<div class="col-sm-6">
						<form action="#" method="post">
							<div class="form-group">
								<label for="notice_writer_name">작성자</label>
								<input type="text" id="notice_writer_name" name="notice_writer_name" class="form-control" readonly="readonly" />
							</div><br />
							<div class="form-group">
								<label for="notice_date">작성일</label> 
								<input type="text" id="notice_date" name="notice_date" class="form-control" readonly="readonly" />
							</div><br />
							<div class="form-group">
